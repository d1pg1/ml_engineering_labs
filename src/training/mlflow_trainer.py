...
def train_with_mlflow(
    ...
    """Train a model and log per-epoch metrics to the active MLflow run.

    Identical checkpoint logic to trainer.train_model; adds mlflow.log_metric
    calls each epoch so callers can compare runs in the MLflow UI.
    The caller is responsible for starting and ending the MLflow run context.
